...
class Product extends Model
{
    ...
    protected $fillable = ['productName', 'Material', 'Size', 'Color', 'Price', 'Designs', 'Quantity', 'ImageUrl',
        'Origin', 'Intro', 'Featured', 'Status', 'supplierID' ,'categoryID' ,'brandID'];

    public function Product(): HasMany
    {
        return $this->hasMany('App\Models\Product', 'productID') ->with('Product');

    }
    public function post()
    {
        return $this->hasMany('App\Models\Post', 'productID');
    }
